...
const renderAsideProfile = () => (
  <Card transparent>
    <Section>
      ...
      <Text secondary>
        Employers cant view your profile or resumes or contact you with job opportunities.
      </Text>
    </Section>
  </Card>
);
...
const renderAsideRecommendedJobs = () => (
  <Card>
    <Section>
      ...
      <Text>
        Every day we look for new opportunities for you based on your profile, search, save and apply activity.
      </Text>
      <Text>
        <TextLink href="https://www.seek.com.au">Review your profile</TextLink>
      </Text>
      <Text>
        <TextLink href="https://www.seek.com.au">Start a new search</TextLink>
      </Text>
    </Section>
  </Card>
);
...
const renderJobDetailDate = () => <Text headline secondary>18 Jan 2017</Text>;
...
const renderJobDetailMetadata = () => (
  <div>
    <Card>
      <Section group>
        <Section>
          <Button color="pink" className={styles.fullWidthTextField}>
            Apply for this job
          </Button>
        </Section>
        <Section>
        ...
        <Section>
          <Columns tight>
            <Button color="gray" className={styles.fullWidthTextField}>
              <StarIcon /> Save Job
            </Button>
            <Button color="gray" className={styles.fullWidthTextField}>
              <MailIcon /> Send Job
    ...
    return (
      <div>
          ...
          <AsidedLayout reverse renderAside={renderAsideProfile} size="340px">
            ...
            <Card>
              <Section>
                ...
                <Text>
                  The more you let employers know about your experince the more you can stand out from other candidates.
                </Text>
          ...
          <AsidedLayout reverse renderAside={renderAsideSignIn} size="360px">
            <Card>
              <Section slim className={styles.cardHeader}>
                <TextLink href="https://www.seek.com.au" chevron="right">
                  Are you an Employer?
                </TextLink>
              </Section>
        ...
        <PageBlock>
          ...
          <AsidedLayout
            reverse
            renderAside={renderAsideRecommendedJobs}
            size="240px"
          >
            <Card group>
              {[0, 1, 2, 3].map(n => (
                <Card key={n}>
                  <Section>
                    <TextLink subheading href="https://www.seek.com.au">
                      Building Supervisor
                    </TextLink>
          ...
          <Card group>
            {[0, 1, 2, 3].map(n => (
              <Card key={n}>
                <Section>
                  <AsidedLayout
                    renderAside={renderAsideMyActivity}
                    size="270px"
                  >
                    <TextLink subheading href="https://www.seek.com.au">
                      Local Health District Registered Nurse
                    </TextLink>
                  ...
                  <AsidedLayout
                    renderAside={renderAsideMyActivityActions}
                    size="270px"
                  >
        ...
        <PageBlock>
          ...
          <AsidedLayout
            reverse
            renderAside={renderJobDetailMetadata}
            size="360px"
          >
            <Card group>
              <Card>
